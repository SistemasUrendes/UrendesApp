...
namespace UrdsAppGestión.Presentacion.Tareas
{
    public partial class FormArbolAreasBloque : Form
    {
        ...
        {
            if (idBloque.Length < 2) return "0000" + idBloque + "S";
            else if (idBloque.Length < 3) return "000" + idBloque + "S";
            else if (idBloque.Length < 4) return "00" + idBloque + "S";
            else if (idBloque.Length < 5) return "0" + idBloque + "S";

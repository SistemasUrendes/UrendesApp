...
namespace UrdsAppGestión.Presentacion.ComunidadesForms.BloquesForms
{
    public partial class FormBloquesAlta : Form
    {
        ...
        public FormBloquesAlta(Bloques form_anterior,String id_comunidad_cargado, String id_bloque,String descripcion, String generales, String baja, String tipoCalculo)
        {
            InitializeComponent();
        ...
        private void FormBloquesAlta_Load(object sender, EventArgs e)
        {
            ...
            if (id_bloque != "0") {
                ...
                if (baja == "True") checkBox_Desactivado.Checked = true;
        ...
        private void button_Guardar_Click(object sender, EventArgs e)
        {
            ...
            if (id_bloque != "0") {
                ...
                String sql = "UPDATE com_bloques SET Descripcion = '" + textBox_Bloque.Text + "', GG = " + general + ", Baja = " + baja + ", IdTipoSubcuota =" + comboBox_tipoCalculo.SelectedValue + " WHERE com_bloques.IdBloque = " + id_bloque;

                Persistencia.SentenciasSQL.InsertarGenerico(sql);
                form_anterior.cargarBloques();
                this.Close();
            }else {
                String sql = "INSERT INTO com_bloques (IdComunidad, Descripcion, IdTipoBloque, GG, Baja, IdTipoSubcuota) VALUES(" + id_comunidad_cargado + ",'" + textBox_Bloque.Text + "',1," + general + "," + baja + "," + comboBox_tipoCalculo.SelectedValue + ")";
                Persistencia.SentenciasSQL.InsertarGenerico(sql);
                form_anterior.cargarBloques();
                this.Close();
            }
